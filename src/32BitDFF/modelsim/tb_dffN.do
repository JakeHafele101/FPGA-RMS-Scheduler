...
##              tb_dffN unit. It adds some useful signals for testing
...
vsim -voptargs=+acc work.tb_dffN

# Add the standard, non-data clock and reset input signals.
add wave -noupdate -divider {Standard Inputs}
add wave -noupdate -label CLK /tb_dffN/s_CLK
add wave -noupdate -label Reset /tb_dffN/s_RST
...
add wave -noupdate -color orange -radix hexadecimal /tb_dffN/s_Q

# Test Inputs
add wave -noupdate -divider {Test Signals}
add wave -noupdate -color cyan -radix hexadecimal /tb_dffN/s_Q_Expected
add wave -noupdate -color cyan -radix unsigned /tb_dffN/s_Q_Mismatch
...
# add wave -noupdate -radix unsigned /tb_dffN/DUT0/*
