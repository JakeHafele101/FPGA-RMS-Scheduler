...
##              tb_decoder_3t8 unit. It adds some useful signals for testing
...
vsim -voptargs=+acc work.tb_decoder_3t8

# Add the standard, non-data clock and reset input signals.
# add wave -noupdate -divider {Standard Inputs}
# add wave -noupdate -label CLK /tb_decoder_3t8/s_CLK
# add wave -noupdate -label Reset /tb_decoder_3t8/s_RST
...
add wave -noupdate -color magenta -radix unsigned /tb_decoder_3t8/s_i_A
add wave -noupdate -color magenta -radix unsigned /tb_decoder_3t8/s_i_WE
...
add wave -noupdate -color orange -radix hexadecimal /tb_decoder_3t8/s_o_F

# Test Inputs
# add wave -noupdate -divider {Test Signals}
# add wave -noupdate -color cyan -radix hexadecimal /tb_decoder_3t8/s_Q_Expected
# add wave -noupdate -color cyan -radix unsigned /tb_decoder_3t8/s_Q_Mismatch
...
# add wave -noupdate -radix unsigned /tb_decoder_3t8/DUT0/*
