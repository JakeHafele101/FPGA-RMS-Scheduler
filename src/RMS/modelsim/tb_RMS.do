...
add wave -noupdate -color magenta -radix unsigned /tb_RMS/s_WE
...
add wave -noupdate -color orange -radix unsigned /tb_RMS/o_count
add wave -noupdate -color orange -radix hexadecimal /tb_RMS/o_LCMclear
