...
HD_PWD='C:/Projects/cpre558/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Quartus_synth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Quartus_synth.tcl
