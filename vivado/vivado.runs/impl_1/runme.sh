...
HD_PWD='C:/Projects/cpre558/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Quartus_synth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Quartus_synth.tcl -notrace
